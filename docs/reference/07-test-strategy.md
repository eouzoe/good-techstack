...
bun test                    # All unit + contract + property
bun test --watch            # TDD mode
bun test --coverage         # Coverage

# CI gate (workerd correctness)
vitest run                  # vitest-pool-workers integration

# Before deployment
bunx playwright test        # E2E (against wrangler dev)

# Production monitoring
bunx wrangler tail          # Real-time error monitoring
```
